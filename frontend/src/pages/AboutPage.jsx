...
const AboutPage = () => {
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="mt-8 bg-blue-50 rounded-2xl p-8 border border-blue-100 text-center relative z-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Need Help with Configuration?</h2>
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          If you need assistance configuring the WhatsApp API or setting up the application, feel free to reach out directly.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="font-semibold text-gray-800">Your WhatsApp Number Here</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="font-semibold text-gray-800">Your Email Here</p>
            </div>
          </div>
        </div>
      </div>
